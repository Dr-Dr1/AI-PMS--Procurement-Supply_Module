...
class Baseline(Base):
    ...
    status: Mapped[str] = mapped_column(
        SAEnum(
            BaselineStatus,
            name="schedule_v2_baseline_status_enum",
    ...
    baseline_type: Mapped[str | None] = mapped_column(
        SAEnum(
            BaselineType,
            name="baseline_type_enum",
            create_constraint=True,
        ),
        nullable=True,
    )

    rebaseline_approved_by: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True),
        nullable=True,
    )
...
class EVMSnapshot(Base):
    ...
    baseline_id: Mapped[uuid.UUID] = mapped_column(
        ForeignKey("baselines.id"), nullable=False, index=True
    )
...
# ============================================================
# ACTIVITY BASELINE LINK
# ============================================================

class ActivityBaselineLink(Base):
    __tablename__ = "activity_baseline_links"
